...
public:
   ...
   /** A zero value indicates that no load balance is attepted; a value
    * of unity indicates that perfect load balance will be attempted. The
    * recommended value is 0.9 to balance the overhead of data exchhanes
    ...
    * A zero value inicates that the peconditioner should be consttructed
    * from scrath. The default value is 0.
    */
